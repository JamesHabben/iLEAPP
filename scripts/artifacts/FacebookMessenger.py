        ...
        if file_found.endswith('.db'):
            ...
            if check:
                ...
                if usageentries > 0:
                    ...
                    report.add_script()
                    data_headers = ('Timestamp','Sender Name','Sender ID','Message',
                ...
                if usageentries > 0:
                    ...
                    report.add_script()
                    data_headers = ('Timestamp','Sender Name','Sender ID',
            ...
            if check:
                ...
                if usageentries > 0:
                    ...
                    report.add_script()
                    data_headers = ('User ID','Username','Normalized Username',
                                    'Profile Pic URL','Is App User')
                    data_list = []
                    for row in all_rows:
            ...
            if check:
                ...
                if usageentries > 0:
                    ...
                    report.start_artifact_report(report_folder,
                                 f'Facebook Messenger - Secret Conversation - {basename(file_found)}')
                    report.add_script()
                    data_headers = ('Timestamp','Thread Key','Sender Name','Message (Encrypted)',
            ...
            if check:
                ...
                if usageentries > 0:
                    ...
                    report.start_artifact_report(report_folder,
                                 f'Facebook Messenger - Conversation Groups - {basename(file_found)}')
                    report.add_script()
                    data_headers = ('Timestamp (Last Activity)','Thread Key','Thread Participants')
                    data_list = []
                    for row in all_rows:
                        data_list.append((
                            (row[0], 'datetime'),
