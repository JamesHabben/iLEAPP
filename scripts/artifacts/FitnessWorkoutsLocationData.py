...
# Fitness Workouts Location Data Analysis
    ...
    if usageentries > 0:
        ...
        report.add_script()
        data_headers = (
            'Workout Start Time', 'Min Location Timestamp', 'Workout End Time', 'Max Location Timestamp',
            'Number of Location Points', 'Expected Number of Location Points', 'Workout Type', 'Elapsed Time',
            'Workout Time', 'Location Data Capture Timespan', 'Location Data Capture Average (in Seconds)')
