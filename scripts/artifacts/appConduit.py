...
def get_appConduit(files_found, report_folder, seeker, wrap_text, timezone_offset):
    ...
    data_headers = ('Timestamp', 'Device interaction', 'Device ID', 'Log File Name')

    report = ArtifactHtmlReport('App Conduit')
    report.start_artifact_report(report_folder, 'App Conduit',
                 'The AppConduit log file stores information about interactions between iPhone and '
                                 'other iOS devices, i.e. Apple Watch')
